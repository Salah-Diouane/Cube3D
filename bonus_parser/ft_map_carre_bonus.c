...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_map_carre_bonus.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: sdiouane <sdiouane@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/06 16:28:59 by sdiouane          #+#    #+#             */
/*   Updated: 2024/08/13 21:46:25 by sdiouane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**ft_new_map(t_data *data, char **map)
{
	...
	if (!new_map)
		return (NULL);
	data->map.wd = longest_length - 1;
	data->map.ht = ft_get_rows(new_map);
	ft_free_2d(map);
	return (new_map);
}
...
int	ft_parsing(t_data	*data, char **arv)
{
	...
	if (ft_check_map(data) != 0)
		return (printf("ft_check_map failed !!!!\n"));
